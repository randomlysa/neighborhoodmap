...
var ViewModel = function(data) {
  ...
  */
  this.searchFlickr = function (query, callback) {
    ...
    var addImage = 0;
    if (jQuery.browser.mobile) {
      // mobile browser, use 150px images so the flickr images take up half the window and the
      // other half is a link to more photos;
      if (orientation === 'wide') {
    ...
    var howManyImagesWillFit = Math.floor(availableWidth / flickrImageWidth) + addImage;
